...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('settings')->insert([
            ...
            ['setting'=>'contact','option'=>'enable','created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s')],
            ['setting'=>'comment','option'=>'enable','created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s')],
            ['setting'=>'post','option'=>'enable','created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s')],
            ['setting'=>'recommended','option'=>'enable','created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s')],
            ['setting'=>'imageupload','option'=>'enable','created_at'=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s')],
            ['setting'=>'search','option'=>'enable',''=>date('Y-m-d H:i:s'),'updated_at'=>date('Y-m-d H:i:s')]
        ]);
    }
}
